...
const CreateUserModal = ({ isOpen, onClose, onUserCreated, t }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (password.length < 6) { // Validação simples
        ...
        try {
            ...
            // Envia para a API de criação de utilizador
    ...
    return (
        <div className="fixed inset-0 bg-black/60 z-40 flex items-center justify-center p-4 backdrop-blur-sm">
            <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
            >
                <h2 className="text-xl font-semibold text-white mb-6">{t('adminUsers.modalTitle', 'Criar Novo Utilizador')}</h2>
    ...
    return (
        <div>
            ...
            <CreateUserModal
                ...
                t={t} // Passa a função de tradução para o modal
            />
